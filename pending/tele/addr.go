...
func NewNetAddr(id sys.Id, pid int, addr net.Addr) *Addr {
	return &Addr{ID: id, PID: pid, TCP: addr.(*net.TCPAddr)}
}

func NewAddr(id sys.Id, pid int, hostport string) (sys.Addr, error) {
